...
window.onload = function () {
    ...
    let totalList = [];
    const pictureList = [
        "./image/shop_clothes_img_1.jpg",
        "./image/shop_clothes_img_2.jpg",
        "./image/shop_clothes_img_3.jpg",
        "./image/shop_clothes_img_4.jpg"
    ];
    const nameList = ["Volume Long Skirt_Beige", "Sleeveless Wrap Dress_ Charcoal Black", "Camisole Onepiece_ Dark Khaki", "Crop Shirts_Oatmeal"];
    const priceList = ["168,000원", "238,000원", "178,000원", "138,000원"];
    let i = 0;

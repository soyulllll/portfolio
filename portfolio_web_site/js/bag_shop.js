...
window.onload = function () {
    ...
    let totalList = [];
    const pictureList = [
        "./image/shop_bag_img_1.jpg",
        "./image/shop_bag_img_2.jpg",
        "./image/shop_bag_img_3.jpg",
        "./image/shop_bag_img_4.jpg"
    ];
    const nameList = ["Baum_Black", "Revo_Choco", "Creta_L_Choco", "Manati_White"];
    const priceList = ["288,000원", "188,000원", "288,000원", "178,000원"];
    let i = 0;

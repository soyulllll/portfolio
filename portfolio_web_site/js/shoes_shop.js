...
window.onload = function () {
    ...
    let totalList = [];
    const pictureList = [
        "./image/shop_shoes_img_1.jpg",
        "./image/shop_shoes_img_2.jpg",
        "./image/shop_shoes_img_3.jpg",
        "./image/shop_shoes_img_4.jpg"
    ];
    const nameList = ["YSD0557_IV", "YSD0557_DBR", "YSD0557_TP", "YSD0557_WN"];
    const priceList = ["178,000원", "178,000원", "178,000원", "178,000원"];
    let i = 0;
